...
public:
    ...
    int main()
    {
        ...
        {
            new Student("ABC",dt[0],dp[0],1001,4,301),
            new Student("DEF",dt[1],dp[1],1002,4,400),
            new Student("GHI",dt[2],dp[2],1003,2,200)
        };
        Faculty *f[2]=                                ///faculty object declaration.
        {
            new Faculty("XYZ","Professor",dp[3]),
            new Faculty("PQR","Lecturer",dp[4])
        };
